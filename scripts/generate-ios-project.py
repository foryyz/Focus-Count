...
for name in ['EventAnalytics', 'MarkerOverviewData', 'MarkerPointLayout', 'MarkerColors', 'MarkerPointTimeline', 'MarkerFrequencyOverview', 'MarkerRangeNavigator', 'MarkerTimelineChart', 'FocusAnalysisData', 'FocusAppearanceStore', 'FocusShareChart', 'TodaySummaryView', 'TargetCountdown']:
 filename=name+'.swift'
...
for mode in ['Debug','Release']:
 ...
 CURRENT_PROJECT_VERSION = 4; MARKETING_VERSION = 1.3.0; CODE_SIGN_STYLE = Automatic;
